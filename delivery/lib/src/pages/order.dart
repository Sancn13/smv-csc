  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: _con.order == null
          ...
          : Container(
              height: _con.order.deliveryStatusId == '10' ? 190 : 250,
              padding: EdgeInsets.symmetric(horizontal: 20, vertical: 15),
              decoration: BoxDecoration(
                  color: Theme.of(context).primaryColor,
                  borderRadius: BorderRadius.only(topRight: Radius.circular(20), topLeft: Radius.circular(20)),
              ...
              child: SizedBox(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    _con.order.deliveryStatusId != '10' ? SizedBox(height: 20) : SizedBox(height: 0),
                    _con.order.deliveryStatusId != '10'
                        ? SizedBox(
                            width: MediaQuery.of(context).size.width - 40,
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text(
                                      'Order status: ' + _con.order.orderStatus.status,
                                      overflow: TextOverflow.ellipsis,
                                      maxLines: 2,
                                      style: Theme.of(context).textTheme.caption,
                                    ),
                                    Text(
                                      'Delivery status' + ': ' + _con.order.deliveryStatus.toString(),
                                      style: Theme.of(context).textTheme.caption,
                                    ),
                                  ],
                                ),
