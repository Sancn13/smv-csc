...
Future<Address> changeCurrentLocation(Address _address) async {
  if (!_address.isUnknown()) {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.setString('cscmultishop_delivery_address', json.encode(_address.toMap()));
  }
  return _address;
}
...
Future<Address> getCurrentLocation() async {
  SharedPreferences prefs = await SharedPreferences.getInstance();
  //await prefs.clear();
  if (prefs.containsKey('cscmultishop_delivery_address')) {
    deliveryAddress.value = Address.fromJSON(json.decode(prefs.getString('cscmultishop_delivery_address')));
