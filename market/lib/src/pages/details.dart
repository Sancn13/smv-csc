      ...
      switch (tabItem) {
        ...
        case 1:
          if (currentUser.value.apiToken == null) {
            ...
            Conversation _conversation = new Conversation(_con.market?.users?.map((e) {e.image = _con.market.image;return e;})?.toList(),
                name: _con.market.name,thumbnail: _con.market.image.thumb);
