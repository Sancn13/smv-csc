                          ...
                          children: <Widget>[
                            Row(
                              children: <Widget>[
                                ...
                                Helper.getPrice(widget.order.subtotal, context, style: Theme.of(context).textTheme.headline4)
                              ]
                            ),
                            Row(
                              children: <Widget>[
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                Helper.getPrice(widget.order.subtotal_discount, context, style: Theme.of(context).textTheme.headline4)
                              ],
                            ),
                            Row(
                              children: <Widget>[
